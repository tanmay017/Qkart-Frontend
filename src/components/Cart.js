...
export default class Cart extends React.Component {
  ...
  getQuantityElement = (item) => {
    ...
    return (<InputNumber size = "small" min={1} max={10} defaultValue={item.qty} onChange={(value) => {this.pushToCart(item.productId, value, false)}} />);
  };
    ...
    return (
      ...
      >
        ...
        {/* TODO: CRIO_TASK_MODULE_CART - If props.checkout is not set, display a checkout button*/}
          {this.props.checkout ? null : <Button type="primary" className = "checkout-btn" icon = {<ShoppingCartOutlined/>} onClick = {this.checkoutClickHandler}>Checkout</Button>}
